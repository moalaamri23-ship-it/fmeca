...
const PROVIDER_MODELS: Record<string, string[]> = {
    ...
    anthropic: ['Codex-sonnet-4-20250514', 'Codex-haiku-4-5-20251001', 'Codex-opus-4-6'],
...
const DEFAULT_MODELS: Record<AIProvider, string> = {
    ...
    anthropic: 'Codex-sonnet-4-20250514', azure: '', openrouter: '', copilot: ''
};
...
- Anthropic — live fetch; default `Codex-sonnet-*`; fallback list in `PROVIDER_MODELS`
...
export interface TieredModels {
    ...
    balanced: string[];   // general purpose (gpt-4o class, gemini standard, Codex sonnet)
